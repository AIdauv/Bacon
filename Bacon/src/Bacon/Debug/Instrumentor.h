...
#define BC_PROFILE 1
    ...
    #define BC_PROFILE_SCOPE(name) ::Bacon::InstrumentationTimer timer##__LINE__(name);
    #define BC_PROFILE_FUNCTION() BC_PROFILE_SCOPE(__FUNCSIG__)
#else
    #define BC_PROFILE_BEGIN_SESSION(name, filepath)
    #define BC_PROFILE_END_SESSION()
    #define BC_PROFILE_SCOPE(name)
    #define BC_PROFILE_FUNCTION()
#endif